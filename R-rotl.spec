...
Version  : 3.0.5
Release  : 5
URL      : https://cran.r-project.org/src/contrib/rotl_3.0.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rotl_3.0.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1538245786
