...
Version  : 3.0.4
Release  : 1
URL      : https://cran.r-project.org/src/contrib/rotl_3.0.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rotl_3.0.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530371096
