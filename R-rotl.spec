...
Version  : 3.0.6
Release  : 6
URL      : https://cran.r-project.org/src/contrib/rotl_3.0.6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rotl_3.0.6.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548006738
